...
namespace Mackay_Nel_Task1
{
    ...
    class RougeWizardUnit : Unit
    {
        ...
        public RougeWizardUnit(int x, int y, int h, int s, int a, int ar, int f, string sy, string ur)//Task 2 Q)2.3 added unit types
        {
            XPos = x;
            YPos = y;
            Health = h;
        ...
        public static explicit operator RougeWizardUnit(MeleeUnit v)
        {
